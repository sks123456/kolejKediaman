              ...
              <div class="dropdown-menu dropdown-menu-end content-dd dropdown-menu-animate-up user-dd animated flipInY" aria-labelledby="drop1">
                <div class="profile-dropdown position-relative" data-simplebar>
                  ...
                  <div class="d-grid py-4 px-7 pt-8">
                    <a href="<?php echo base_url('CodeIgniterTraining/index.php/logincontroller/logout') ?>" class="btn btn-info">Log Out</a>
                  </div>
                </div>
              </div>
            </li>
    ...
    <nav class="navbar navbar-expand-xl container-fluid p-0">
      ...
      <ul class="navbar-nav quick-links d-none d-xl-flex">
        ...
        <li class="nav-item hover-dd dropdown mega-dropdown">
          <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
            <iconify-icon icon="solar:widget-linear"></iconify-icon>
          </a>
              ...
              <div class="col-8">
                <div class="ps-3 pt-3">
                  ...
                  <div class="row align-items-center py-3">
                    <div class="col-8">
                      <a class="text-dark d-flex align-items-center lh-1 fs-3" href="#"><i class="ti ti-help fs-4 me-2"></i>Frequently Asked Questions</a>
                    </div>
                    <div class="col-4">
