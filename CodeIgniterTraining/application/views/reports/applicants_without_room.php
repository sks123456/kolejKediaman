                ...
                <div class="container-fluid">
                    <div class="d-md-flex align-items-center justify-content-between mb-7">
                        <div class="mb-4 mb-md-0">
                            <h4 class="fs-6 mb-0">List of Applicant without Room Report</h4>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item">
                                        <a class="text-muted text-decoration-none" href="http://localhost/FYP_kk/CodeIgniterTraining/index.php/">Reports</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">List of Applicant without Room Report</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card w-100 position-relative overflow-hidden">
                                <div class="px-4 py-3 border-bottom">
                                    <div class="d-flex align-items-center">
                                        <h4 class="me-3 mb-0">List of Applicant without Room</h4>
                                        <div class="ms-auto">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($applicants as $applicant) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $applicant->CHANNEL_NAME; ?></td>
                                                        <td class="text-center"><?php echo $applicant->APPLICATION_STATUS; ?></td>
