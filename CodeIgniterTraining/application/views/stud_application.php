...
<div class="content-wrapper" style="min-height:max-content;">
    ...
    <section class="content">
        <form role="form" action="<?= base_url() ?>CodeIgniterTraining/index.php/application/stud_submit_application" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td class="col-md-2"><label for="Channels">Saluran Permohonan </label>
                                    </td>
                                    <td class="col-md-3">
            ...
            <!-- <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Rekod Penempatan Lepas</h3>
            </div> -->
            <!-- <div class="box-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php foreach ($record_penempatan as $penempatan) : ?>
                            <tr>
                                <td><?= $penempatan['SESSION_NAME'] ?></td>
                                <td><?= $penempatan['room_allocated'] ?></td>
                                <td><?= $penempatan['room_type'] ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
