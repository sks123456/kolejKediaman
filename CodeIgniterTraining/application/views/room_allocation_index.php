                ...
                <div class="container-fluid">
                    <div class="d-md-flex align-items-center justify-content-between mb-7">
                        <div class="mb-4 mb-md-0">
                            <h4 class="fs-6 mb-0">Registration Session</h4>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Registration Session</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card w-100 position-relative overflow-hidden">
                                <div class="px-4 py-3 border-bottom">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title mb-0">List of Room Allocations</h4>
                                    </div>
                                </div>
                                <div class="card-body p-4">
                                    <div class="table-responsive mb-4">
                                        <?php $this->load->view("room_allocation_view"); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
