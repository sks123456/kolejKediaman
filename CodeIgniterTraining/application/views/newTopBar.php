...
<div class="message-body" data-simplebar>
  <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
    <span class="user-img position-relative d-inline-block">
      <img src="<?php echo base_url() ?>monster-bt5-v8/dist/assets/images/profile/user-2.jpg" alt="user" class="rounded-circle w-100 round-40" />
  ...
  <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
    <span class="user-img position-relative d-inline-block">
      <img src="<?php echo base_url() ?>monster-bt5-v8/dist/assets/images/profile/user-3.jpg" alt="user" class="rounded-circle w-100 round-40" />
      <span class="profile-status bg-success position-absolute rounded-circle"></span>
    </span>
    <div class="w-75 d-inline-block v-middle">
      <div class="d-flex align-items-center justify-content-between">
  ...
  <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
    <span class="user-img position-relative d-inline-block">
      <img src="<?php echo base_url() ?>monster-bt5-v8/dist/assets/images/profile/user-4.jpg" alt="user" class="rounded-circle w-100 round-40" />
      <span class="profile-status bg-success position-absolute rounded-circle"></span>
    </span>
    <div class="w-75 d-inline-block v-middle">
      <div class="d-flex align-items-center justify-content-between">
  ...
  <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
    <span class="user-img position-relative d-inline-block">
      <img src="<?php echo base_url() ?>monster-bt5-v8/dist/assets/images/profile/user-5.jpg" alt="user" class="rounded-circle w-100 round-40" />
      <span class="profile-status bg-success position-absolute rounded-circle"></span>
    </span>
    <div class="w-75 d-inline-block v-middle">
      <div class="d-flex align-items-center justify-content-between">
  ...
  <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
    <span class="user-img position-relative d-inline-block">
      <img src="<?php echo base_url() ?>monster-bt5-v8/dist/assets/images/profile/user-6.jpg" alt="user" class="rounded-circle w-100 round-40" />
      <span class="profile-status bg-success position-absolute rounded-circle"></span>
    </span>
    <div class="w-75 d-inline-block v-middle">
      <div class="d-flex align-items-center justify-content-between">
  ...
  <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
    <span class="user-img position-relative d-inline-block">
      <img src="<?php echo base_url() ?>monster-bt5-v8/dist/assets/images/profile/user-7.jpg" alt="user" class="rounded-circle w-100 round-40" />
      <span class="profile-status bg-success position-absolute rounded-circle"></span>
    </span>
    <div class="w-75 d-inline-block v-middle">
      <div class="d-flex align-items-center justify-content-between">
  ...
  <a class="d-flex align-items-center pt-3 pb-2 justify-content-center text-dark" href="javascript:void(0);">
    ...
    <iconify-icon icon="solar:alt-arrow-right-linear"></iconify-icon>
      ...
      <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
        ...
        <li class="nav-item hover-dd dropdown">
          <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" aria-expanded="false">
            <img src="<?php echo base_url() ?>monster-bt5-v8/dist/assets/images/svgs/icon-flag-en.svg" alt="" width="20px" height="20px"
          ...
          <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
            <div class="message-body">
              ...
              <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                <div class="position-relative">
                  <img src="<?php echo base_url() ?>monster-bt5-v8/dist/assets/images/svgs/icon-flag-cn.svg" alt="" width="20px" height="20px"
                    class="rounded-circle object-fit-cover round-20" />
                </div>
              ...
              <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                <div class="position-relative">
                  <img src="<?php echo base_url() ?>monster-bt5-v8/dist/assets/images/svgs/icon-flag-fr.svg" alt="" width="20px" height="20px"
                    class="rounded-circle object-fit-cover round-20" />
                </div>
              ...
              <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                <div class="position-relative">
                  <img src="<?php echo base_url() ?>monster-bt5-v8/dist/assets/images/svgs/icon-flag-sa.svg" alt="" width="20px" height="20px"
                    class="rounded-circle object-fit-cover round-20" />
                </div>
          ...
          <a class="nav-link" href="javascript:void(0)" id="drop1" aria-expanded="false">
            <div class="d-flex align-items-center">
              <div class="user-profile-img">
                <img src="<?php echo base_url() ?>monster-bt5-v8/dist/assets/images/profile/user-1.jpg" class="rounded-circle" width="30" height="30"
                  alt="" />
              </div>
            </div>
          </a>
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level my-3">
                        ...
                        <ul class="px-8 mt-7 mb-4">
                            ...
                            <li class="sidebar-item py-2">
                                <a class="fs-3"
                                    href="<?php echo base_url() ?>monster-bt5-v8/dist/main/authentication-login.html">Authentication Design</a>
                            </li>
                            <li class="sidebar-item py-2">
                                <a class="fs-3"
                                    href="<?php echo base_url() ?>monster-bt5-v8/dist/main/authentication-register.html">Register Now</a>
                            </li>
                            <li class="sidebar-item py-2">
                            ...
                            <li class="sidebar-item py-2">
                                <a class="fs-3"
                                    href="<?php echo base_url() ?>monster-bt5-v8/dist/main/page-account-settings.html">Account Settings</a>
                            </li>
                        </ul>
                    </ul>
                </li>
  ...
  <a class="d-flex align-items-center pt-3 pb-2 justify-content-center text-dark" href="javascript:void(0);">
        ...
        <div class="ps-3 pt-3">
            <div class="border-bottom">
                <div class="row">
                    <div class="col-6">
                        <div class="position-relative">
                            <a href="<?php echo base_url() ?>monster-bt5-v8/dist/main/app-chat.html" class="d-flex align-items-center pb-9 position-relative ">
                                <div
                                    class="bg-primary-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                    <iconify-icon icon="solar:chat-line-linear" class="text-primary fs-5"></iconify-icon>
                                </div>
                            ...
                            <a href="<?php echo base_url() ?>monster-bt5-v8/dist/main/app-invoice.html" class="d-flex align-items-center pb-9 position-relative">
                                <div
                                    class="bg-secondary-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                    <iconify-icon icon="solar:bill-list-linear" class="text-secondary fs-5"></iconify-icon>
                                </div>
                            ...
                            <a href="<?php echo base_url() ?>monster-bt5-v8/dist/main/app-contact2.html" class="d-flex align-items-center pb-9 position-relative">
                                <div
                                    class="bg-success-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                    <iconify-icon icon="solar:bedside-table-2-linear" class="text-success fs-5"></iconify-icon>
                                </div>
                            ...
                            <a href="<?php echo base_url() ?>monster-bt5-v8/dist/main/app-email.html" class="d-flex align-items-center pb-9 position-relative">
                                <div
                                    class="bg-warning-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                    <iconify-icon icon="solar:letter-unread-linear" class="text-warning fs-5"></iconify-icon>
                                </div>
                    ...
                    <div class="col-6">
                        <div class="position-relative">
                            <a href="<?php echo base_url() ?>monster-bt5-v8/dist/main/page-user-profile.html" class="d-flex align-items-center pb-9 position-relative">
                                <div
                                    class="bg-danger-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                    <iconify-icon icon="solar:cart-large-2-linear" class="text-danger fs-5"></iconify-icon>
                                </div>
                            ...
                            <a href="<?php echo base_url() ?>monster-bt5-v8/dist/main/app-calendar.html" class="d-flex align-items-center pb-9 position-relative">
                                <div
                                    class="bg-primary-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                    <iconify-icon icon="solar:calendar-linear" class="text-primary fs-5"></iconify-icon>
                                </div>
                            ...
                            <a href="<?php echo base_url() ?>monster-bt5-v8/dist/main/app-contact.html" class="d-flex align-items-center pb-9 position-relative">
                                <div
                                    class="bg-secondary-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                    <iconify-icon icon="solar:bedside-table-linear" class="text-secondary fs-5"></iconify-icon>
                                </div>
                            ...
                            <a href="<?php echo base_url() ?>monster-bt5-v8/dist/main/app-notes.html" class="d-flex align-items-center pb-9 position-relative">
                                <div
                                    class="bg-success-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                    <iconify-icon icon="solar:palette-linear" class="text-success fs-5"></iconify-icon>
                                </div>
            ...
            <div class="row align-items-center py-3">
                <div class="col-8">
                    <a class="text-dark d-flex align-items-center lh-1 fs-3" href="#"><i
                            class="ti ti-help fs-4 me-2"></i>Frequently Asked Questions</a>
                </div>
                <div class="col-4">
    ...
    <div class="col-4 ms-n4">
        <div class="position-relative p-3 border-start h-100">
            ...
            <ul>
                <li class="mb-3">
                    <a class="fs-3" href="<?php echo base_url() ?>monster-bt5-v8/dist/main/page-pricing.html">Pricing Page</a>
                </li>
                <li class="mb-3">
                ...
                <li class="mb-3">
                    <a class="fs-3" href="<?php echo base_url() ?>monster-bt5-v8/dist/main/authentication-error.html">404 Error Page</a>
                </li>
                <li class="mb-3">
                    <a class="fs-3" href="<?php echo base_url() ?>monster-bt5-v8/dist/main/app-notes.html">Notes App</a>
                </li>
                <li class="mb-3">
                    <a class="fs-3" href="<?php echo base_url() ?>monster-bt5-v8/dist/main/page-user-profile.html">User Application</a>
                </li>
                <li class="mb-3">
        ...
        <li class="nav-item search-box d-none d-md-flex align-items-center">
          <div class="nav-link">
            <form class="app-search position-relative">
              ...
              <a href="#" class="srh-btn"><iconify-icon icon="solar:magnifer-linear"
