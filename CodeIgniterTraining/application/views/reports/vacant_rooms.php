                ...
                <div class="container-fluid">
                    <div class="d-md-flex align-items-center justify-content-between mb-7">
                        <div class="mb-4 mb-md-0">
                            <h4 class="fs-6 mb-0">Vacant Room Statistics</h4>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item">
                                        <a class="text-muted text-decoration-none" href="http://localhost/FYP_kk/CodeIgniterTraining/index.php/">Reports</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">Vacant Room Statistics</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        <table class="table border text-nowrap mb-0 align-middle">
                                            <thead class="text-center">
                                                <tr>
                                                    ...
                                                    <th>Room Type</th>
                                                    <th>Capacity</th>
                                                    <th>Total Empty Spots</th>

                                                </tr>
                                            </thead>
                                            <tbody class="text-center">
                                                <?php foreach ($vacant_rooms as $row) : ?>
                                                    <tr>
                                                        <td><?= $row->KOLEJ ?></td>
                                                        <td><?= $row->BLOCK ?></td>
