        ...
        <div class="container-fluid">
          <div class="d-md-flex align-items-center justify-content-between mb-7">
            <div class="mb-4 mb-md-0">
              <h4 class="fs-6 mb-0">Uniform Unit</h4>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Uniform Unit</li>
                </ol>
              </nav>
            </div>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card w-100 position-relative overflow-hidden">
                <div class="px-4 py-3 border-bottom">
                  <div class="d-flex align-items-center">
                    <h4 class="card-title mb-0">List of Uniforms</h4>
                    <div class="ms-auto">
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content" style="width:100%">
                          <div class="modal-header d-flex align-items-center">
                            <h4 class="modal-title"><?= isset($update) && $update ? 'Update Uniform' : 'Create New Uniform' ?></h4>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          </div>
                          <?php $this->load->view("uniform_form") ?>
                        </div>
                      </div>
                      <!-- /.modal-content -->
                    </div>
              ...
              <div class="card-body p-4">
                <div class="table-responsive mb-4">
                  <?php $this->load->view("senarai_uniform"); ?>
                </div>
              </div>
            </div>
          </div>
