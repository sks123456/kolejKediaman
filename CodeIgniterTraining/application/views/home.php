                    ...
                    <div class="col-md-4">
                        <div class="card bg-dark">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Makluman Pelajar</h5>
                                <ul class="list-unstyled">
                                    <li><a href="#" class="text-dark">Enrolmen</a></li>
                                    <li><a href="#" class="text-dark">Carian Pelajar</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-dark">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Setup Maklumat</h5>
                                <ul class="list-unstyled">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-dark">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Bilik</h5>
                                <ul class="list-unstyled">
                                    <li><a href="#" class="text-dark">Senarai Bilik Senior(KK)</a></li>
                                    <li><a href="#" class="text-dark">Jana Bilik</a></li>
                                    <li><a href="#" class="text-dark">Kemaskini Bilik</a></li>
                                    <li><a href="#" class="text-dark">Kemaskini Blok</a></li>
                                    <li><a href="#" class="text-dark">Jana Penempatan Bilik</a></li>
                                    <li><a href="#" class="text-dark">Ralat Kapasiti Bilik</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-dark">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="#" class="text-dark">Pendaftaran Permohonan</a></li>
                                    <li><a href="#" class="text-dark">Kemaskini Status Kelulusan</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-dark">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="#" class="text-dark">Senarai Keseluruhan</a></li>
                                    <li><a href="#" class="text-dark">Senarai Permohonan</a></li>
                                    <li><a href="#" class="text-dark">Senarai Permohonan Rayuan</a></li>
                                    <li><a href="#" class="text-dark">Senarai Mengikut Status Kelulusan</a></li>
                                    <li><a href="#" class="text-dark">Senarai Penempatan Bilik</a></li>
                                    <li><a href="#" class="text-dark">Senarai Tiada Penempatan</a></li>
                                    <li><a href="#" class="text-dark">Senarai Bilik</a></li>
                                    <li><a href="#" class="text-dark">Statistik Saluran/Jantina</a></li>
                                    <li><a href="#" class="text-dark">Statistik Status/Saluran/Jantina</a></li>
                                    <li><a href="#" class="text-dark">Statistik Status Pengesahan</a></li>
                                    <li><a href="#" class="text-dark">Statistik Bilik Kosong</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
