                ...
                <div class="container-fluid">
                    <div class="d-md-flex align-items-center justify-content-between mb-7">
                        <div class="mb-4 mb-md-0">
                            <h4 class="fs-6 mb-0">Validation Status Statistics</h4>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item">
                                        <a class="text-muted text-decoration-none" href="http://localhost/FYP_kk/CodeIgniterTraining/index.php/">Reports</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">Validation Status Statistics</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card w-100 position-relative overflow-hidden">
                                <div class="px-4 py-3 border-bottom">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title mb-0">Validation Status Statistics</h4>
                                        <div class="ms-auto">
                                    ...
                                    <div class="table-responsive mb-4">
                                        <table class="table border text-nowrap mb-0 align-middle">
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                foreach ($validation_stats as $stat) : ?>
                                                    <tr>
                                                        <td><?= $stat['VALIDATION_STATUS'] ?></td>
                                                        <td><?= $stat['MALE'] ?></td>
                                                        <td><?= $stat['FEMALE'] ?></td>
                                                        <td><?= $stat['TOTAL'] - ($stat['MALE'] + $stat['FEMALE']) ?></td>
                                                        <td><?= $stat['TOTAL'] ?></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
